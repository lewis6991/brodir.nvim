...
nmap <silent> <buffer> <CR>  <cmd>lua package.loaded.dirvish.open(nil, 'edit'   )<CR>
nmap <silent> <buffer> v     <cmd>lua package.loaded.dirvish.open(nil, 'vsplit' )<CR>
nmap <silent> <buffer> V     <cmd>lua package.loaded.dirvish.open(nil, 'vsplit' )<CR>
nmap <silent> <buffer> s     <cmd>lua package.loaded.dirvish.open(nil, 'split'  )<CR>
nmap <silent> <buffer> S     <cmd>lua package.loaded.dirvish.open(nil, 'split'  )<CR>
nmap <silent> <buffer> t     <cmd>lua package.loaded.dirvish.open(nil, 'tabedit')<CR>
nmap <silent> <buffer> T     <cmd>lua package.loaded.dirvish.open(nil, 'tabedit')<CR>
